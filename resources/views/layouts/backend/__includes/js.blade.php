...
<script src="{{ env('APP_URL') }}/assets/backend/vendor/libs/sortablejs/sortable.js"></script>
<script src="{{ env('APP_URL') }}/assets/backend/js/cards-actions.js"></script>

<script src="{{ env('APP_URL') }}/assets/backend/vendor/libs/datatables-bs5/datatables-bootstrap5.js"></script>
<!-- Flat Picker -->
